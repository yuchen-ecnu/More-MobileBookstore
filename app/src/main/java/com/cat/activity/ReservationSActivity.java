...
public class ReservationSActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reservation_s);
        initview();
        loadData();
    }
    ...
    private void loadData() {
        ...
        asyncHttpClient.post(BASEURL + "bookShelf/reservationInfoForSender",rp, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(JSONObject response) {
                ...
                try {
                    ...
                    if (retcode != null && !retcode.equals("0000")) {
                        ...
                        Toast.makeText(ReservationSActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
            ...
            public void onFailure(Throwable error) {
                ...
                dialog.dismiss();
                Toast.makeText(ReservationSActivity.this, "网络出错，请检查网络！", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void initview() {
        ...
        dialog = new SpotsDialog(ReservationSActivity.this);
        ...
        reservationAdapter = new ReservationAdapter(ReservationSActivity.this,list);
        listView.setAdapter(reservationAdapter);
